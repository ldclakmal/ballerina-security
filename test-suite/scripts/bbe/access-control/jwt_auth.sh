...
sed -i 's+../resource/path/to+resources+g' packages/bbe/access-control/jwt-auth/http_service_with_jwt_auth.bal
sed -i 's+../resource/path/to+resources+g' packages/bbe/access-control/jwt-auth/http_client_with_self_signed_jwt_auth.bal
