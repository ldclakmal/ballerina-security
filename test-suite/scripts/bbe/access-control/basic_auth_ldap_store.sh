...
sed -i 's+../resource/path/to+resources+g' packages/bbe/access-control/basic-auth-ldap-store/http_service_with_basic_auth_ldap_user_store.bal
sed -i 's+../resource/path/to+resources+g' packages/bbe/access-control/basic-auth-ldap-store/http_client_with_basic_auth.bal
