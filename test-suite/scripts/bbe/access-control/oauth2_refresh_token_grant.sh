...
sed -i 's+../resource/path/to+resources+g' packages/bbe/access-control/oauth2-refresh-token-grant/http_service_with_oauth2.bal
sed -i 's+../resource/path/to+resources+g' packages/bbe/access-control/oauth2-refresh-token-grant/http_client_with_oauth2_refresh_token_grant_type.bal
