...
curl https://raw.githubusercontent.com/${1}/ballerina-distribution/${2}/examples/http-client-oauth2-password-grant-type/http_client_oauth2_password_grant_type.bal -o oauth2/client.bal
