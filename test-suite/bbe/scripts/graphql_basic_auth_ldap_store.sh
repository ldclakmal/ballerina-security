...
mkdir auth
curl https://raw.githubusercontent.com/ldclakmal/ballerina-distribution/bbe-revamp/new-examples/graphql-service-basic-auth-ldap-user-store/graphql_service_basic_auth_ldap_user_store.bal -o auth/service.bal
