...
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/bbe-revamp/examples/graphql-service-ssl-tls/graphql_service_ssl_tls.bal -o ssl/service.bal
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/bbe-revamp/examples/http-service-ssl-tls/tests/graphql_service_ssl_tls_test.bal -o ssl/tests/service_test.bal
sed -i 's+../resource/path/to+resources+g' ssl/service.bal
sed -i 's+../resource/path/to+resources+g' ssl/tests/service_test.bal
bal build ssl
sleep 10s

curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/bbe-revamp/examples/http-client-ssl-tls/http_client_ssl_tls.bal -o ssl/client.bal
