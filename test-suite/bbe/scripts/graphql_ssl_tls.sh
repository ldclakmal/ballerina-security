...
curl https://raw.githubusercontent.com/ldclakmal/ballerina-distribution/bbe-revamp/new-examples/graphql-service-ssl-tls/graphql_service_ssl_tls.bal -o ssl/service.bal
curl https://raw.githubusercontent.com/ldclakmal/ballerina-distribution/bbe-revamp/new-examples/http-service-ssl-tls/tests/graphql_service_ssl_tls_test.bal -o ssl/tests/service_test.bal
