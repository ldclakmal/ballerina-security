...
curl https://raw.githubusercontent.com/${organization}/ballerina-distribution/${branch}/examples/http-service-ssl-tls/tests/graphql_service_ssl_tls_test.bal -o ssl/tests/service_test.bal
