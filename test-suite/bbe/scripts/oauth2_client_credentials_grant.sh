...
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/master/examples/http-client-with-oauth2-client-credentials-grant-type/http_client_with_oauth2_client_credentials_grant_type.bal -o oauth2/client.bal
