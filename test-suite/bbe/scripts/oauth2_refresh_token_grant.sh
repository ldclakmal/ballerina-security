...
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/master/examples/http-client-with-oauth2-refresh-token-grant-type/http_client_with_oauth2_refresh_token_grant_type.bal -o oauth2/client.bal
