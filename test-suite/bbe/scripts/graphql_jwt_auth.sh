...
mkdir jwt
curl https://raw.githubusercontent.com/ldclakmal/ballerina-distribution/bbe-revamp/new-examples/graphql-service-jwt-auth/graphql_service_jwt_auth.bal -o jwt/service.bal
