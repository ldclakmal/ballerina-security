...
curl https://raw.githubusercontent.com/ldclakmal/ballerina-distribution/bbe-revamp/new-examples/graphql-service-mutual-ssl/graphql_service_mutual_ssl.bal -o mtls/service.bal
curl https://raw.githubusercontent.com/http_mtls.sh/ballerina-distribution/bbe-revamp/new-examples/graphql-service-mutual-ssl/tests/graphql_service_mutual_ssl_test.bal -o mtls/tests/service_test.bal
