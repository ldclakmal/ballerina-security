...
mkdir jwt
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/master/examples/http-service-jwt-auth/http_service_jwt_auth.bal -o jwt/service.bal
