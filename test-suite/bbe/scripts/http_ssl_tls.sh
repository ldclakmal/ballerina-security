...
curl https://raw.githubusercontent.com/${1}/ballerina-distribution/${2}/examples/http-service-ssl-tls/http_service_ssl_tls.bal -o ssl/service.bal
curl https://raw.githubusercontent.com/${1}/ballerina-distribution/${2}/examples/http-service-ssl-tls/tests/http_service_ssl_tls_test.bal -o ssl/tests/service_test.bal
