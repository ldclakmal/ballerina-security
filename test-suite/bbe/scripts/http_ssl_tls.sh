...
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/master/examples/http-service-ssl-tls/http_service_ssl_tls.bal -o ssl/service.bal
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/master/examples/http-service-ssl-tls/tests/http_service_ssl_tls_test.bal -o ssl/tests/service_test.bal
