...
mkdir auth
curl https://raw.githubusercontent.com/${1}/ballerina-distribution/${2}/examples/http-service-basic-auth-file-user-store/http_service_basic_auth_file_user_store.bal -o auth/service.bal
