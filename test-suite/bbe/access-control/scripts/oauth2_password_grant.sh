...
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/master/examples/http-client-with-oauth2-password-grant-type/http_client_with_oauth2_password_grant_type.bal -o oauth2/client.bal
