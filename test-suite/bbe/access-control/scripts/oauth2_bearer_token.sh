...
sed -i 's+../resource/path/to+packages/resources+g' packages/oauth2-bearer-token/http_service_with_oauth2.bal
sed -i 's+../resource/path/to+packages/resources+g' packages/oauth2-bearer-token/http_client_with_bearer_token_auth.bal
