...
sed -i 's+../resource/path/to+packages/resources+g' packages/jwt-auth/http_service_with_jwt_auth.bal
sed -i 's+../resource/path/to+packages/resources+g' packages/jwt-auth/http_client_with_self_signed_jwt_auth.bal
