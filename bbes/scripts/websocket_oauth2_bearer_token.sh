...
curl https://raw.githubusercontent.com/${organization}/ballerina-distribution/${branch}/examples/websocket-client-bearer-token-auth/websocket_client_bearer_token_auth.bal -o bbe/client.bal
