...
curl https://raw.githubusercontent.com/${organization}/ballerina-distribution/${branch}/examples/grpc-service-basic-auth-ldap-user-store/grpc_service_basic_auth_ldap_user_store.bal -o bbe/service/service.bal
curl https://raw.githubusercontent.com/${organization}/ballerina-distribution/${branch}/examples/grpc-service-basic-auth-ldap-user-store/grpc_service.proto -o bbe/service/service.proto
...
curl https://raw.githubusercontent.com/${organization}/ballerina-distribution/${branch}/examples/grpc-client-basic-auth/grpc_client.proto -o bbe/client/client.proto
