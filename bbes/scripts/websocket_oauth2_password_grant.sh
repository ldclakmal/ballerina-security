...
curl https://raw.githubusercontent.com/${organization}/ballerina-distribution/${branch}/examples/websocket-client-oauth2-password-grant-type/websocket_client_oauth2_password_grant_type.bal -o oauth2/client.bal
