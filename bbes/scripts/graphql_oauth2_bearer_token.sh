...
mkdir bbe
curl https://raw.githubusercontent.com/${organization}/ballerina-distribution/${branch}/examples/graphql-service-oauth2/graphql_service_oauth2.bal -o bbe/service.bal
curl https://raw.githubusercontent.com/${organization}/ballerina-distribution/${branch}/examples/http-client-bearer-token-auth/http_client_bearer_token_auth.bal -o bbe/client.bal
