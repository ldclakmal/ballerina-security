...
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/master/examples/http-client-oauth2-jwt-bearer-grant-type/http_client_oauth2_jwt_bearer_grant_type.bal -o bbe/client.bal
