...
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/master/examples/websocket-client-oauth2-jwt-bearern-grant-type/websocket_client_oauth2_jwt_bearer_grant_type.bal -o bbe/client.bal
