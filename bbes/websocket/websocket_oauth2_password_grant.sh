...
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/master/examples/websocket-client-oauth2-password-grant-type/websocket_client_oauth2_password_grant_type.bal -o bbe/client.bal
