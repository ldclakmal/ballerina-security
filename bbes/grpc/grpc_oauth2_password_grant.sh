...
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/master/examples/grpc-client-oauth2-password-grant-type/grpc_client.proto -o bbe/client/client.proto
