...
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/$ACTIVE_BRANCH/examples/grpc-client-oauth2-password-grant-type/grpc_client_oauth2_password_grant_type.bal -o bbe/client/client.bal
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/$ACTIVE_BRANCH/examples/grpc-client-oauth2-password-grant-type/grpc_client.proto -o bbe/client/grpc_client.proto
