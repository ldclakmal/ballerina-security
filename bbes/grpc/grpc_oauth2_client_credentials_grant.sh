...
curl https://raw.githubusercontent.com/ballerina-platform/ballerina-distribution/master/examples/grpc-client-oauth2-client-credentials-grant-type/grpc_client.proto -o bbe/client/client.proto
