...
public isolated client class DeliveryServiceClient {
    *grpc:AbstractClientEndpoint;
    ...
    isolated remote function delivery(string|ContextString req) returns (string|grpc:Error) {
    ...
    isolated remote function deliveryContext(string|ContextString req) returns (ContextString|grpc:Error) {
        map<string|string[]> headers = {};
        string message;
        if (req is ContextString) {
            message = req.content;
...
const string ROOT_DESCRIPTOR = "";
