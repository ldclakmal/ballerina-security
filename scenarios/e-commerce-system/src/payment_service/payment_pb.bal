...
public isolated client class PaymentServiceClient {
    *grpc:AbstractClientEndpoint;
    ...
    isolated remote function payments(string|ContextString req) returns (string|grpc:Error) {
    ...
    isolated remote function paymentsContext(string|ContextString req) returns (ContextString|grpc:Error) {
        map<string|string[]> headers = {};
        string message;
        if (req is ContextString) {
            message = req.content;
...
const string ROOT_DESCRIPTOR = "";
